    var slow = window.prompt("Slow Lane (OK) or Fast Lane (Cancel)?","Slow Lane");
    if(slow){
        ...
        var inter = setInterval(function(){
            ...
            //shade.style.height = eval("'" + parseFloat(shade.style.height.split('px')[0]) * .98 + "px'");
            shade.style.height = parseFloat(shade.style.height.split('px')[0]) * .98 + "px";
        },100);
